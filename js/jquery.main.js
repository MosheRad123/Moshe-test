...
function initNavigationSelect() {
  jQuery('.blog-nav .category-list').navigationSelect({
    activeClass: 'active',
...
function initSlickCarousel() {
  ...
  ResponsiveHelper.addRange({
    '..767': {
      ...
      off: function() {
        jQuery('.news-mobile-slider').slick('unslick');
      }
    }
  });
}
...
function initTabNav() {
  ...
  jQuery(document).on('keyup', 'a[href="#main"]', function(e) {
    if(e.which == 13) {
      jQuery('#header a, #header button, #header input, a[accesskey="c"], .side-sticky-deals a, .side-sticky-deals button').attr('tabindex', '-1');
    }
  });

  jQuery(document).on('keyup', '#main a, #main button, #main input', function(e) {
    if(e.which == 9) {
      jQuery('#header a, #header button, #header input, a[accesskey="c"], .side-sticky-deals a, .side-sticky-deals button').attr('tabindex', '1');
  ...
  jQuery(document).on('keyup', '#header a, #header button, #header input, a[accesskey="c"], .side-sticky-deals a, .side-sticky-deals button', function(e) {
    if(e.which == 9) {
      jQuery('a[href="#main"]').attr('tabindex', '1');
    }
  });
